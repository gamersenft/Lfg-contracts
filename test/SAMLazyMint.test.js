...
describe("SAMLazyMint", function () {
  ...
  before("Deploy contract", async function () {
    try {
      ...
      LFGNFT1155 = await LFGNFT1155Art.new(owner, UserWhiteList.address, "");
      ...
      await UserWhiteList.setUserWhitelist([SAMLazyMint.address, accounts[2]], [true, true], {from: owner});
